...
def test_performance_reports_top_capacity_metrics(monkeypatch) -> None:
    cases = [
        {"risk_score": 0.95, "confirmed_abuse_label": 1, "risk_band": "High"},
        {"risk_score": 0.80, "confirmed_abuse_label": 0, "risk_band": "High"},
        {"risk_score": 0.65, "confirmed_abuse_label": 1, "risk_band": "Medium"},
        {"risk_score": 0.20, "confirmed_abuse_label": 0, "risk_band": "Low"},
    ]
